...
const getUser = async () =>{
    ...
    const response = await getuser(user.value.id_user);
...
.container-navbar .container-content{
    padding: 1rem;
    width: calc(100% - 2rem);
    height: 100%;
}

.container-content .user-profile{
    display: flex;
    align-items: center;
